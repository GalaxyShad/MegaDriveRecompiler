...
struct IFoundInstructionNotifier {
    ...
    virtual void btst_dn(u8 dn, AddressingMode m, u8 xn) = 0;
    virtual void bchg_dn(u8 dn, AddressingMode m, u8 xn) = 0;
    virtual void bclr_dn(u8 dn, AddressingMode m, u8 xn) = 0;
    virtual void bset_dn(u8 dn, AddressingMode m, u8 xn) = 0;
    virtual void movep(u8 dn, DirectionR d, Size s, u8 an,
                       u16 displacement) = 0;
